...
def populate_programs_collection
  ...
  Programa.create :aceita_emenda_parlamentar => true, :_id => 12345678945,
  ...
  Programa.create :aceita_emenda_parlamentar => true, :_id => 565689765465,
  ...
  Programa.create :aceita_emenda_parlamentar => true, :_id => 798432120,
  ...
  Programa.create :aceita_emenda_parlamentar => true, :_id => 6648785121321,
